    ...
    if (bart_with_bias_) {
        ...
        if (use_gated_activation_) {
            ...
            loadWeightFromBin<T>(weights_ptr_[14],
                                 ...
                                 model_file_type);
            loadWeightFromBin<T>(
                weights_ptr_[15], {weights_size_[15]}, dir_path + "intermediate.layer_norm.bias.bin", model_file_type);
        }
    }
